    ...
    <div className="dashboard-page" suppressHydrationWarning>
        ...
        <div className="header-left">
          <div className="user-dropdown">
            <div className="user-avatar">
              <img src="/aba-logo.png" alt="ABA Bank Logo"
          ...
          <div className={`settings-container lang ${isLangMenuOpen ? "open" : ""}`}>
            ...
            {isLangMenuOpen && (
              <div ref={langMenuRef} className="lang-menu">
                <div className="lang-item" onClick={() => handleLanguageChange("km")}>
                  <Image src="/khmer.png" alt="Khmer" width={16} height={12} />
                  <div>ខ្មែរ</div>
                </div>

                <div className="lang-item" onClick={() => handleLanguageChange("en")}>
                  <Image src="/english.png" alt="English" width={16} height={12} />
                  <div>English</div>
                </div>

                <div className="lang-item" onClick={() => handleLanguageChange("zh")}>
      ...
      <div className={`main-container ${!isSidebarVisible ? "sidebar-collapsed" : ""}`}>
        ...
        <div className="content">
          <div className="page-title">{t("កម្មវិធីគ្រប់គ្រង")}</div>

          {/* EXACT SAME FILTER STRUCTURE */}
      ...
      <button className="add-button">
        ...
        <span>{t("Add New Management")}</span>
      </button>
